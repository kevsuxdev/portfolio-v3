...
const WhoAmI = () => {
  return (
    <section id='who-am-i' className='min-h-screen p-32 max-lg:px-10 flex flex-col items-center justify-center gap-10'>
      <article className='flex flex-col gap-5 w-full'>
        ...
        <motion.h1
            ...
            viewport={{ once: true }}
            className='text-5xl font-semibold tracking-tight w-1/2 text-white/50 max-xl:w-full max-lg:text-2xl'
        >
        ...
        <motion.p
            ...
            viewport={{ once: true }}
            className='text-lg font-light max-lg:text-base'
        >
